...
class m131214_130539_yz_admin_add_default_admin extends \yii\db\Migration
{
    public function up()
    {
        ...
        $this->insert('{{%admin_users}}', [
            ...
            'is_super_admin' => 1,
            'is_active' => 1,
            'auth_key' => \Yii::$app->security->generateRandomString(\yz\admin\models\User::AUTH_KEY_LENGTH),
            'access_token' => \Yii::$app->security->generateRandomString(\yz\admin\models\User::ACCESS_TOKEN_LENGTH),
            'email' => $email,
