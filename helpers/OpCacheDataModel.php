...
/**
 * Class OpCacheDataModel is based on the {@link https://github.com/rlerdorf/opcache-status}
 */
class OpCacheDataModel extends Object
{
    const THOUSAND_SEPARATOR = true;

    private $_opcacheEnabled;
    ...
    public function getIsOpCacheEnabled()
    {
        return $this->_opcacheEnabled;
    }
